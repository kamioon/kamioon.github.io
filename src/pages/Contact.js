const Contact = () => {
    return (
        <div id="contact" className="contact">
            <h1>Contact me</h1>
            <p>
                I would love to hear from you. Whether you have a question, suggestion, or just want to say hello. Feel
            ...
            <ul className="social-networks">
                ...
                <li className="github"><a href="https://github.com/kamioon" target="_blank" rel="noreferrer">Github</a>
                </li>
                <li className="stackoverflow"><a href="https://stackoverflow.com/users/7238282/kamran" target="_blank"
